...
function renderCharts(vessels) {
    ...
    if (ctx1) {
        new Chart(ctx1, {
            ...
            options: { responsive: true, plugins: { legend: { position: 'top', labels: { font: { size: 10 } } } }, scales: { y: { beginAtZero: true } } }
        });
    }
    ...
    if (ctx2) {
        new Chart(ctx2, {
            ...
            options: { responsive: true, plugins: { legend: { position: 'top', labels: { font: { size: 10 } } } }, scales: { y: { beginAtZero: true, max: 100 } } }
        });
    }
    ...
    if (ctx3) {
        new Chart(ctx3, {
            ...
            options: { responsive: true, plugins: { legend: { position: 'bottom', labels: { font: { size: 10 } } } }, cutout: '60%' }
        });
    }
