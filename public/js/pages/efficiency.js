...
<div id="page-efficiency">
    <style>
        ...
        .stat-card {
            background: linear-gradient(135deg,
                rgba(24, 34, 56, 0.85) 0%,
                rgba(18, 26, 44, 0.95) 100%);
        ...
        .filter-bar .btn-filter.primary:hover {
            transform: translateY(-2px);
            box-shadow: 0 10px 28px var(--c-gold-glow);
        }
        ...
        thead::after {
            ...
            background: linear-gradient(90deg,
                transparent 0%, #f7d774 20%, #e6b31e 50%, #f7d774 80%, transparent 100%);
        ...
        thead th i {
            ...
            color: #f7d774;
            font-size: 11px;
            filter: drop-shadow(0 0 6px rgba(247, 215, 116, 0.8));
        }
        tbody td {
            padding: 14px 16px;
    ...
    <!-- جدول 2: الشمال -->
    <div class="eff-section" data-section-key="region-الشمال">
        <div class="section-header">
            <h3><i class="fas fa-map-pin"></i> الحرس البحري بالشمال</h3>
            <span class="badge gold" id="badge-region-الشمال">0% جاهزية</span>
        </div>
        <div class="section-content">
            <div class="table-wrapper">
                <table>
                    ...
                    <tbody id="body-region-الشمال"></tbody>
                </table>
            </div>
        </div>
    </div>
    ...
    <!-- جدول 3: الساحل -->
    <div class="eff-section" data-section-key="region-الساحل">
        <div class="section-header">
            <h3><i class="fas fa-map-pin"></i> الحرس البحري بالساحل</h3>
            <span class="badge gold" id="badge-region-الساحل">0% جاهزية</span>
        </div>
        <div class="section-content">
            <div class="table-wrapper">
                <table>
                    ...
                    <tbody id="body-region-الساحل"></tbody>
                </table>
            </div>
        </div>
    </div>
    ...
    <!-- جدول 4: الوسط -->
    <div class="eff-section" data-section-key="region-الوسط">
        <div class="section-header">
            <h3><i class="fas fa-map-pin"></i> الحرس البحري بالوسط</h3>
            <span class="badge gold" id="badge-region-الوسط">0% جاهزية</span>
        </div>
        <div class="section-content">
            <div class="table-wrapper">
                <table>
                    ...
                    <tbody id="body-region-الوسط"></tbody>
                </table>
            </div>
        </div>
    </div>
    ...
    <!-- جدول 5: الجنوب -->
    <div class="eff-section" data-section-key="region-الجنوب">
        <div class="section-header">
            <h3><i class="fas fa-map-pin"></i> الحرس البحري بالجنوب</h3>
            <span class="badge gold" id="badge-region-الجنوب">0% جاهزية</span>
        </div>
        <div class="section-content">
            <div class="table-wrapper">
                <table>
                    ...
                    <tbody id="body-region-الجنوب"></tbody>
                </table>
            </div>
        </div>
    </div>
            ...
            async function initEfficiencyPage() {
                ...
                try {
                    ...
                    if (vessels) {
                        ...
                        renderEfficiency();
                        console.log('✅ Efficiency: Data loaded —', vessels.length, 'vessels');
                    }
                } catch (err) {
